...
export const aiSettings = pgTable('ai_settings', {
  ...
  // Max tool steps per turn — added in migration 0011 (was in spec §3.1 but
  // never landed in 0001). Default 6, range 1–12.
  maxSteps: smallint('max_steps').notNull().default(sql`6`),
})
