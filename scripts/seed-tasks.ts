...
async function main() {
  ...
  async function findOrCreateProject(content: string, color: string): Promise<string> {
    ...
    existingNodes.push({ id, userId: user.id, parentId: null, kind: 'project', rank: between(lastRank, null), content, color, isInbox: false, isFavorite: false, isSomeday: false, collapsed: false, createdAt: now, updatedAt: now, deletedAt: null, note: null, linkedTaskId: null, dueDate: null, dueTime: null, durationMin: null, recurrence: null, priority: null, tagIds: [], completedAt: null, seq: 0n })
  ...
  async function findOrCreateTask(opts: {
    ...
    existingNodes.push({ id, userId: user.id, parentId: opts.parentId, kind: 'item', rank: between(lastRank, null), content: opts.content, note: opts.note ?? null, linkedTaskId: null, priority: opts.priority ?? null, dueDate: opts.dueDate ?? null, dueTime: null, durationMin: null, recurrence: null, tagIds: opts.tagIds ?? [], color: null, isInbox: false, isFavorite: false, isSomeday: false, collapsed: false, completedAt: null, createdAt: now, updatedAt: now, deletedAt: null, seq: 0n })
